...
class CustomerCart(models.Model):
    ...
    product = models.ForeignKey(
        Products, on_delete=models.CASCADE, null=False, blank=False)
...
class CustomerCheckout(models.Model):
    ...
    payment_signature = models.CharField(
...
class customerPayedProducts(models.Model):
    ...
    checkout_details = models.ForeignKey(
        CustomerCheckout, on_delete=models.CASCADE, null=False, blank=False)
